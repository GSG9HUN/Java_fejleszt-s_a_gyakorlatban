...
public class RoomController {
    ...
    public String list(){
        ...
        for (Room room: rooms) {
            ...
            System.out.println("Room "+room.getName()+" with "+seats+", "+room.getRowNum()+" rows and "+room.getColNum()+" columns");
        }
        return null;
    }
    ...
    public String updateRoom(String roomName, int rowNum,int colNum){
